<x-app-layout>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Manajemen Divisi</h2>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Daftar divisi dalam perusahaan.</p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="p-8 text-center text-slate-400 dark:text-slate-500 text-sm">
