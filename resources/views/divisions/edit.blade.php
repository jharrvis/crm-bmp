<x-app-layout>
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Edit Divisi</h2>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Perbarui informasi divisi.</p>
            </div>
            ...
            <form action="{{ route('divisions.update', $division) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm font-medium">{{ old('description', $division->description) }}</textarea>
