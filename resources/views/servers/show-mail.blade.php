        ...
        <div class="grid gap-6 xl:grid-cols-3">
            <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm xl:col-span-2 dark:border-slate-700 dark:bg-slate-800">
                ...
                <dl class="grid gap-x-6 gap-y-5 p-6 sm:grid-cols-2">
                    ...
                    <div><dt class="text-xs font-bold uppercase tracking-wide text-slate-400">Versi Zimbra</dt><dd class="mt-1 font-semibold text-slate-800 dark:text-slate-100">{{ ($remote['version'] ?? null) ?: 'Tidak tersedia dari API' }}</dd></div>
                    ...
                    <div><dt class="text-xs font-bold uppercase tracking-wide text-slate-400">ID Zimbra</dt><dd class="mt-1 break-all font-mono text-sm text-slate-800 dark:text-slate-100">{{ ($remote['server_id'] ?? null) ?: 'Tidak tersedia dari API' }}</dd></div>
