    ...
    <div class="fixed inset-0 z-40 flex flex-wrap min-h-screen w-full bg-white dark:bg-slate-900 overflow-y-auto">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 md:px-24 xl:px-32 py-10 relative">
            ...
            <div class="w-full max-w-md mx-auto mt-12 lg:mt-0">
                <h1 class="text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl">Forgot Password</h1>
                <p class="mt-2 text-slate-500 dark:text-slate-400">Reset akses akun internal Anda.</p>

                <x-auth-session-status class="mt-8" :status="session('status')" />

                <div class="mt-8 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 px-4 py-3 text-sm leading-6 text-slate-500 dark:text-slate-400">
