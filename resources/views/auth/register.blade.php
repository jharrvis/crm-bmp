    ...
    <div class="fixed inset-0 z-40 flex flex-wrap min-h-screen w-full bg-white dark:bg-slate-900 overflow-y-auto">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 md:px-24 xl:px-32 py-10 relative">
            ...
            <div class="w-full max-w-md mx-auto mt-12 lg:mt-0">
                <h1 class="text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl">Sign Up</h1>
                <p class="mt-2 text-slate-500 dark:text-slate-400">Buat akun baru untuk mengakses sistem.</p>
                ...
                <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-5">
                    ...
                    <div>
                        <label for="name" class="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-300">
                    ...
                    <button type="submit" id="register-btn" class="w-full rounded-lg bg-blue-600 px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-500/50 disabled:opacity-70 flex justify-center items-center gap-2">
